...
#ifdef __SSE4_2__
    template <>
    KR8MD_INLINE puint32_4::Pak(const uint32_t &value) : intrinsic(_mm_set1_epi32(static_cast<int32_t>(value))){};
...
#ifdef __AVX2__
    template <>
    KR8MD_INLINE puint32_8::Pak(const uint32_t &value) : intrinsic(_mm256_set1_epi32(static_cast<int32_t>(value))){};
